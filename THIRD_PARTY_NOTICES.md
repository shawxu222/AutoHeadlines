...
- [Ollama for macOS](https://ollama.com/download/mac), distributed by the Ollama
  project under the [MIT License](https://github.com/ollama/ollama/blob/main/LICENSE).
- [`qwen3:8b`](https://ollama.com/library/qwen3:8b), downloaded through Ollama.
  The model page identifies the model as licensed under the Apache License 2.0.
